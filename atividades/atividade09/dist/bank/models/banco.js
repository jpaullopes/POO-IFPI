...
var Banco = /** @class */ (function () {
    ...
    Banco.prototype.consultarConta = function (numero) {
        var contaProcurada = this.contas.find(function (conta) { return conta.getNumero() == numero; }) || new conta_1.Conta(-1, "", 0, new cliente_1.Cliente());
    ...
    Banco.prototype.renderJuros = function (numeroConta) {
        var contaProcurada = this.consultarConta(numeroConta);
    ...
    Banco.prototype.debitarImposto = function (numeroConta, valor) {
        var contaProcurada = this.consultarConta(numeroConta);
        if (contaProcurada instanceof contaImposto_1.ContaImposto) {
